...
namespace Calculator.CalcViews
{
    ...
    /// </summary>
    public sealed partial class SnappedScientific : Page, CalculatorView, ScientificView
    {
        private Calc_MainPage _mainPage;
        private bool _funcVisible;

        // Calc State
        private Calc_MainPage.CalcStateValues scientificCalcStateInternal;
        Calc_MainPage.CalcStateValues ScientificView.scientificCalcState
        {
            get { return scientificCalcStateInternal; }
            set
            {
                scientificCalcStateInternal = value;
                Calc_MainPage.scientificCalcState = scientificCalcStateInternal;
            }
        }

        public SnappedScientific(Calc_MainPage mainPage)
        {
